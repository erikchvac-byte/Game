...
| 2026-05-09 | Plant/Shadow ground_offset corrected (0,12)→(0,22) to sit at base of 48×48 centered sprite. Well/Shadow widened to (22,9), cast_length→5 for a more grounded static look. Log ("18") collision changed Circle r=20→RectangleShape2D 50×22 at (0,18); LogCollider reset to (0,0). Stray Trees/5.png sprite reparented from inside LogCollider to World root at (94,188). TreeWillowWeeping given Shadow + TreeCollider (CircleShape2D r=7 at y=18). Rock123x20 found missing from scene — not restored. |
